...
class TipodocumentoPolicy
{
    ...
    {
        return $user->can('view_any_tipodocumento');
    }
    ...
    {
        return $user->can('view_tipodocumento');
    }
    ...
    {
        return $user->can('create_tipodocumento');
    }
    ...
    {
        return $user->can('update_tipodocumento');
    }
    ...
    {
        return $user->can('delete_tipodocumento');
    }
    ...
    {
        return $user->can('delete_any_tipodocumento');
    }
    ...
    {
        return $user->can('force_delete_tipodocumento');
    }
    ...
    {
        return $user->can('force_delete_any_tipodocumento');
    }
    ...
    {
        return $user->can('restore_tipodocumento');
    }
    ...
    {
        return $user->can('restore_any_tipodocumento');
    }
    ...
    {
        return $user->can('replicate_tipodocumento');
    }
    ...
    {
        return $user->can('reorder_tipodocumento');
    }
